...
void Result::AddButtons()
{
	...
	m_pBM->AddButton(300, 730, "To Menu", 100, 30, true, true, cN, cH, cD, false, sceneMenu);
	m_pBM->AddButton(410, 730, "To Join", 100, 30, true, true, cN, cH, cD, false, sceneJoin);
	m_pBM->AddButton(515, 730, "To Host", 100, 30, true, true, cN, cH, cD, false, sceneHost);
}
