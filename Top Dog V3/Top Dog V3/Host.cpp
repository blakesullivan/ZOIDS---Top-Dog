...
void Host::AddOptions()
{
	...
	m_pBM->AddButton(500, 225, "City", 75, 30, false, true, cN, cH, cD, false, buttonCity);
	m_pBM->AddButton(600, 225, "Lake", 75, 30, false, true, cN, cH, cD, false, buttonLake);
