...
void Menu::Init()
{
	...
	int iStartPos = 200, iButtSpace = 110;
	m_pBM->AddButton(350, iStartPos+(iButtSpace*0), "Join", 300, 100, true, true, cN, cH, cD, false, sceneJoin);
	m_pBM->AddButton(350, iStartPos+(iButtSpace*1), "Host", 300, 100, true, true, cN, cH, cD, false, sceneHost);
	m_pBM->AddButton(350, iStartPos+(iButtSpace*2), "Options / Instructions", 300, 100, true, true, cN, cH, cD, false, sceneOptions);
	m_pBM->AddButton(350, iStartPos+(iButtSpace*3), "Exit", 300, 100, true, true, cN, cH, cD, false, buttonExit);
}
